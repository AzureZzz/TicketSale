            ...
            <div class=" col-md-offset-2 col=md-8">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="/busNum">汽车时刻表</a></li>
    ...
    <div class="search-box">
        <div class="search">
            <div class=" col-md-offset-1 col-md-10" style="padding: 13px 15px;background-color: #fff;margin-top: 25px;">
                <form class="form-inline layui-form" action="/busNum/info">
        ...
        <div class="traffic_information col-md-offset-1 col-md-8 claerfix" style="padding: 0">
            <div class="traffic_inf_title">
                <dl>
                    ...
                    <dt id="go_listNum" class="left traffic_inf_xial">(共${fn:length(busNums)}条车次信息)</dt>
                </dl>

            </div>
            <table class="table table-striped">
                <thead class="traffic_jie_title  ">
                <th width="20%" > 出发时间/价格</th>
                <th width="30%">出发站</th>
                <th width="30%">到达站</th>
                <th width="20%">车次</th>
                <%--<th width="10%"></th>--%>
                ...
                <c:forEach items="${busNums}" var="busNum">
                    <tr>
                        <td><fmt:formatDate value="${busNum.goOff}" pattern="HH:MM" />/${busNum.piece}</td>
                        <td><span>&nbsp;&nbsp;${busNum.startStation}</span></td>
                        <td><span>&nbsp;&nbsp;${busNum.desStation}</span></td>
                        <td><span>&nbsp;&nbsp;${busNum.numNo}</span></td>
                        <%--<td><a class="btn btn-primary" role="button" href="/busBill" target="_blank">购票</a></td>--%>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
