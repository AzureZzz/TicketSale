                        ...
                        <div class="layui-card">
                            ...
                            <div class="layui-card-body">
                                <div class="layui-btn-group demoTable">
                                    <button class="layui-btn" data-type="add_trainnum">新增车次</button>
                                </div>
...
<div id="new_trainnum" style="height: 320px;padding: 30px;display: none">
    <form class="layui-form" id="new_form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input id="arrive" name="arrive" type="text" required lay-verify="" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
        </div>
...
<div id="modify_trainnum" style="height: 320px;padding: 30px;display: none">
    <form class="layui-form" id="new_form1">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <label class="layui-form-label" style="width: 100px;">到达</label>
                <div class="layui-input-block">
                    <input id="arrive1" name="arrive" type="text" required lay-verify="" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label" style="width: 100px;">车次</label>
            <div class="layui-input-block" style="width: 150px;">
                <input id="trainNo1" name="trainNo" disabled="" type="text" required lay-verify="" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item float-right">
...
<script>
    layui.use(['table','element','form','laydate'], function(){
        ...
        table.on('tool(late_filter)', function(obj){
            var data = obj.data;
            if(obj.event === 'del'){
                layer.confirm('确定删除改车次？', function(index){
                    data1={
                ...
                $('#arrive1').val(new Date(data.arrive).Format("yyyy-MM-dd HH:mm:ss"));
                ...
                layer.open({
                    ...
                    ,content: $('#modify_trainnum')
                });
            }
        });

        var $ = layui.$, active = {
            add_trainnum: function(){
                layer.open({
                    type: 1
                    ,title: ['新增车次']
                    ,closeBtn: false
            ...
            reload: function(){
                table.render({
                    ...
                    ,cellMinWidth: 80
                    ,cols: [[
                        {field:'trainNo', title:'车次号', width:100, unresize: true}
